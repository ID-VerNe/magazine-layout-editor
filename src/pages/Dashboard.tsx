      ...
      <nav className="h-16 bg-white border-b border-slate-200 flex items-center justify-between sticky top-0 z-50 pr-8 shadow-sm">
        <div className="flex items-center">
          <div className="w-16 h-16 flex items-center justify-center">
            <div className="w-10 h-10 bg-[#264376] rounded-xl flex items-center justify-center text-white font-black shadow-lg shadow-[#264376]/20 text-sm">M</div>
          </div>
                  ...
                  >
                    <div className="h-[300px] bg-white relative border-b border-slate-50 flex items-center justify-center overflow-hidden">
                      <div className="absolute top-4 left-4 z-20">
                        <span className={`px-2 py-1 rounded-[4px] text-[8px] font-black uppercase tracking-widest shadow-sm ${template.category === 'Cover' ? 'bg-slate-900 text-white' : 'bg-blue-600 text-white'}`}>{template.category}</span>
                      </div>
