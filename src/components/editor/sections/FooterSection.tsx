      ...
      <div className="flex justify-between items-end mb-4">
        ...
        <div className="flex items-center gap-4">
          <label className="flex items-center gap-2 cursor-pointer group">
            <span className="text-[9px] text-slate-400 font-bold uppercase group-hover:text-slate-600 transition-colors">
              Swap Position
            </span>
            <div
          ...
          <div className="flex bg-slate-100 p-0.5 rounded-md mb-1">
            <button
              ...
              className={`flex-1 text-[8px] py-1 rounded ${
                page.footerRightType !== 'logo' ? 'bg-white shadow-sm' : 'text-slate-400'
              }`}
            >
              TEXT
            </button>
