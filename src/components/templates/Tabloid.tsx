    ...
    <div className="w-full h-full flex flex-col font-sans overflow-hidden">
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-[#e21f26] text-white p-4 flex justify-between items-center relative z-20">
          <span className="font-black text-4xl italic tracking-tighter transform skew-x-[-10deg] leading-none whitespace-nowrap overflow-hidden">
            {formatMagazineText(magName)}
          </span>
        ...
        <div className="flex-1 p-8 relative flex flex-col justify-center overflow-hidden">
